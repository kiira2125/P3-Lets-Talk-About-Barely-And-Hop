          ...
          return(
              <Col xs={12}>
                  <h2 className='totalFollowingHeader'>
                      Total Following is: {this.state.followingArr.length} Brewers
                  </h2>
    ...
    return(
     <div className='profileBackground'>
      <Grid>
       ...
       <Row>
       <AddRecipeButton id={this.state.id} />
       </Row>
      <Row>
        <Col xs={12}>
          <SecondaryNav currentComp={this.state.currentComp} handleComponentChange={this.handleComponentChange} />
        </Col>
        </Row>
        <Row>
